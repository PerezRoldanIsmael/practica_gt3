...
namespace practica_gt3.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Grupo_Nombre")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Grupo_Nombre")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {
